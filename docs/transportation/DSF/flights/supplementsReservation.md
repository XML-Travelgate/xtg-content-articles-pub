...
### SupplementsReservationRQ Example
...
| @type                         | 0..1      | String    | [Type of charge.](#supplementsReservation-enumerate-description) |
...
| @resident                 | 0..1      | String    | [Resident discount type.](#supplementsReservation-enumerate-description)|
...
| @discountCard     | 0..1  | String    | [Discount card type.](#supplementsReservation-enumerate-description)|
...
| @type | 0..1  | String    | [Discount card type.](#supplementsReservation-enumerate-description)|
...
| @specialSupplementType   | 1 | String     | [Special Service type.](#supplementsReservation-enumerate-description).|
| @code   | 1       | String    | Code.|
| @quantity   | 0..1        | Decimal   | Quantity.|
| @carrier   | 0..1         | String    | Carrier.|
...
| @type                         | 1         | String    | [Seat type.](valuation.md#valuation-enumerate-description)|
| Client   	| 0..1  		|    		| Contains client's information.      |
| @title   | 1  		| String 	| Treatment.                          |
| @name     | 1  		| String 	| Name.                               |
...
| Locators/Locator/Type          	| 1  		| String 	| Locator type: PROVIDER, UNIVERSAL, EMISSION and CARRIER.             |
| Email  | 0..1     	|	String		| 		Client's email		|
| PreValuation  | 0..1     	|	Boolean		| Do a valuation before doing reservation |
| DeltaPrice  | 0..1     	|	Decimal		| 	Maximum amount increasement allowed between valuation and reservation			|

### SupplementsReservationRS Example
...
| Locators                	| 0..1    		|			| Reservation locators	 |
| Tickets                	| 0..1    		|			| Reservarion tickets|
| Invoice                	| 0..1    		|			| Reservation invoice. It will be filled if supplements reservation were done correctly|
| OptionalCharges           | 0..1    		|			| |